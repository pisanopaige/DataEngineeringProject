...
def transform_data():
    ...
    # Save the transformed dataset to S3
    ...
    with s3.open(f'{transformed_dir}test_data_transformed.pkl', 'wb') as f_test_transformed:
    ...
    return f'{transformed_dir}X_train_transformed.pkl', f'{transformed_dir}y_train_transformed.pkl', f'{transformed_dir}X_train_balanced.pkl', f'{transformed_dir}y_train_balanced.pkl', f'{transformed_dir}test_data_transformed.pkl'

if __name__ == "__main__":
    X_train_transformed_path, y_train_transformed_path, X_train_balanced_path, y_train_balanced_path, test_data_transformed_path = transform_data()
